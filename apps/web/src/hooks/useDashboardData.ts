  ...
  return [
    {
      ...
      unit: "items",
      description: "Different items in your shop",
      accent: "cyan",
      icon: "Package",
      trend: "up",
    ...
    },
    {
      ...
      unit: "pieces",
      description: "All pieces in your shop",
      accent: "emerald",
      icon: "Boxes",
      trend: "up",
    ...
    },
    {
      ...
      unit: "days",
      description: "Average days for stock to arrive",
      accent: "amber",
      icon: "Clock",
    ...
    },
    {
      ...
      unit: "%",
      description: "How sure the helper is",
      accent: "violet",
      icon: "BrainCircuit",
    ...
    },
    {
      ...
      unit: "%",
      description: "How fast stock sells vs what you have",
      accent: "amber",
      icon: "TrendingUp",
